...
/**
 * Class Mail
 * Клас для відправки E-mail через SMTP
 *
 * @package app\core
...
class Mail {
	...
	/**
	 * SMTP ім'я користувача (email)
	 */
	public $SMTPUsername = '';

	/**
	 * SMTP пароль користувача (від email)
	 */
	public $SMTPPass = '';

	/**
	 * SMTP порт для відправки повідомлень
	 */
	public $SMTPPort = '';
	...
	/**
	 * SMTP емейл для відправки пошти
	 *
	 * @param $email
	 */
	public function SMTPUsername( $email ) {
		$this->SMTPUsername  = $email;
	}

	/**
	 * SMTP пароль від емейлу для відправки пошти
	 *
	 * @param $password
	 */
	public function SMTPPassword( $password ) {
	...
	public function sendSMTP(){
		...
		try {
			...
			$mail->addAddress('support@universedev.io', 'UniverseDev');

			// Content
			$mail->isHTML(true); // Set email format to HTML
			$mail->Subject = $this->subject;
			$mail->Body    = $this->addHtmlStyle( $this->body );
