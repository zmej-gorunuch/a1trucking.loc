    ...
    public function index() {
        ...
        foreach ( $results as $result ) {
            $data['partnerships'][] = [
                ...
                'image'    => $result['image'],
                'href'     => $this->url->link( 'extension/module/partnership/item', 'partnership_id=' . $result['id'], true ),
            ];
        }
        ...
        $this->response->setOutput( $this->load->view( 'extension/module/partnership/category', $data ) );
    }
}