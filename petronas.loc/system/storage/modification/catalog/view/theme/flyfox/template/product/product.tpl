...
<div class="page-wrapper page-product-single">
    ...
    <section class="section product-single text" style="background-image: url(/catalog/view/theme/flyfox/img/product-single-logo.png);">
        <div class="container">
            ...
            <?php debug($product_download); ?>
            <?php endforeach; ?>

            <div class="product-single__download">
                <h3 class="title">СКАЧАТИ ПАРАМЕТРИ ПРОДУКТу</h3>
                <a href="#">Таблиця переваг продукту </a>
                <span>462,83 КБ</span>
            </div>
			  ...
			  <?php if ($downloads){ ?>
				<ul style="list-style:none;">
				  <?php foreach($downloads as $download){ ?>
					<li><i class="<?php echo $download['icon']; ?>"></i> <a href="<?php echo $download['href']; ?>" title="<?php echo $download['name']; ?>" <?php echo (!$download['size']); ?> ><?php echo $download['name']; ?><?php echo ($download['size'])?" (". $download['size'] .")":'';?></a></li>
				  <?php } ?>
				</ul>
			  <?php } ?>	
			</div>
