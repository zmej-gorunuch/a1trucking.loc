...
$_['entry_show_in_top']          	= 'Show category in the top menu';
$_['entry_show_in_top_articles']    = 'Show materials in the top menu category';
$_['entry_show_in_sitemap']       	= 'Show category in the sitemap';
$_['entry_show_in_sitemap_articles']= 'Show materials in the sitemap';

$_['entry_template_category']	= 'Template output categories';
$_['entry_template_article'] 	= 'Article Template output';
$_['entry_images_size']       	= 'Image size on the category page';
$_['entry_images_size_articles_big']	= 'A large image size on a page of material';
$_['entry_images_size_articles_small']	= 'The small size of the material on the page';
$_['entry_date_format']       	= 'The date format for materials';
$_['entry_layout'] 				= 'Choose a layout';

$_['tab_comments'] 				= 'Comments';
$_['entry_comments_vk'] 		= 'Widget Vkontakte';
$_['entry_comments_fb'] 		= 'Widget Facebook';
$_['entry_comments_dq'] 		= 'Widget Disqus';
$_['entry_show_comments_category'] 		= 'Show on category page';
$_['entry_show_comments_article'] 		= 'Show on article page';
...
$_['help_comments_id']         	= 'ID apps:';
$_['help_comments_vk']         	= 'You can get ID app on page <a href="https://vk.com/apps?act=manage" target="_blank">https://vk.com/apps?act=manage</a>';
$_['help_comments_fb']         	= 'To moderate the messages, you will need to add the application or administrator ID to the header. <a href="https://developers.facebook.com/docs/plugins/comments/#moderation-setup-instructions" target="_blank">Instructions</a>';
$_['help_comments_id_dq']       = 'Your website shortname is';
$_['help_comments_dq']         	= 'You must register on the site <a href="https://disqus.com/profile/login/?next=/admin/create/" target="_blank">https://disqus.com/profile/login/?next=/admin/create/</a> to get Shortname';
...
$_['placeholder_image_size_width'] 	= 'Width';
$_['placeholder_image_size_height']	= 'Height';
