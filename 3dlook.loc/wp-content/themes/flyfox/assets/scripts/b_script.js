...
var Selectric = __webpack_require__(/*! ./jquery.selectric.js */ "./src/js/jquery.selectric.js");
...
$('.custom-input-file').each(function () {
  ...
  label = label ? label : 'Select file'; // wrap the file input

  $(this).wrap('<span class="input-file"></span>'); // display label
  ...
  $(this).change(function (e) {
    ...
    var val = $(this).val(); // Let's only show filename.
...
module.exports = __webpack_require__(/*! /var/www/html/src/sass/app.scss */"./src/sass/app.scss");
