		...
		if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
			...
			if ($this->user->hasPermission('access', 'faq/category')) {
				$faq[] = array(
					...
					'href'     => $this->url->link('faq/category', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}
			
			if ($this->user->hasPermission('access', 'faq/article')) {
				$faq[] = array(
					'name'	   => $this->language->get('text_faq_article'),
					'href'     => $this->url->link('faq/article', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}
