													...
													<tbody>
														<tr>
															...
															<td style="padding:0px;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;color:#333333">
																...
																<p style="margin:0;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;color:#555555;font-size:14px;padding-top:10px;"><?php echo $text_greeting; ?> <strong><?php echo $author; ?></strong>,</p>
																<p style="margin:0;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;color:#555555;font-size:14px;padding-top:10px;">
																	<?php echo sprintf($text_download, '<a href="' . $download_link . '" style="text-decoration:none;color:#0084b4;">' . $download_name . '</a>', '<a href="' . $order_link . '" style="text-decoration:none;color:#0084b4;">' . $order_id . '</a>'); ?>
																</p>
																...
																<p style="margin:0;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;color:#555555;font-size:14px;padding-top:10px;"><?php echo $text_view_order; ?>
																	<br/>
																	<a href="<?php echo $order_link; ?>" style="text-decoration:none;color:#0084b4;font-size:12px;"><?php echo $order_link; ?></a>
																</p>
