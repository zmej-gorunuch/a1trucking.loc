...
class ControllerExtensionModulePartnership extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$data['partnerships'][] = array(
				...
				'edit'       => $this->url->link('extension/module/partnership/edit', 'token=' . $this->session->data['token'] . '&partnerships_id=' . $result['id'] . $url, true)
			);
		}
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_extension_module_faq->editPartnership($this->request->get['partnership_id'], $this->request->post);
