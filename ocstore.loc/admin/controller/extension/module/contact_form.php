...
class ControllerMarketingCform extends Controller
{
	...
	protected function getList()
	{
		...
		foreach ($results as $result) {
			...
			$data['cform'][] = array(
				...
				'edit'       => $this->url->link('extension/module/contact_form/edit', 'token=' . $this->session->data['token'] . '&cform_id=' . $result['cform_id'] . $url, true)
			);
		}
		...
		$data['sort_cform_id'] = $this->url->link('extension/module/contact_form', 'token=' . $this->session->data['token'] . '&sort=cform_id' . $url, true);
		$data['sort_cform_email'] = $this->url->link('extension/module/contact_form', 'token=' . $this->session->data['token'] . '&sort=cform_email' . $url, true);
		$data['sort_subscribe_date'] = $this->url->link('extension/module/contact_form', 'token=' . $this->session->data['token'] . '&sort=subscribe_date' . $url, true);
	...
	protected function getForm()
	{
		...
		if (!isset($this->request->get['cform_id'])) {
			...
			$data['action'] = $this->url->link('extension/module/contact_form/edit', 'token=' . $this->session->data['token'] . '&cform_id=' . $this->request->get['cform_id'] . $url, true);
		}
